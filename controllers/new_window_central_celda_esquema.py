...
from views.new_central_celda_ubicacion_esquema import Ui_NewBook
from db.books import delete_esquema_celda_central,buscar_usuario_acceso,insert_book_celda_central_generacion_ubicacion_esquema,select_esquema_celda_central
...
class NewBookWindow(QDialog,Ui_NewBook):
    def __init__(self, parent=None,_codCelda=None,_codCentral=None,_codigo=None):
        ...
        if _codigo is not None:
            ...
            self.btnAddEsquema.setText("GUARDAR")
        self.btnAddEsquema.clicked.connect(self.add_book)
        ...
        self.btnDeleteEsquema.clicked.connect(self.remove_book)
        ...
        self.table_config()
        self.populate_table(select_esquema_celda_central(self._codCentral,self.inputCelda.text()))
        ...
        if len(selected_row)!=0:
            ...
            if respuesta== QMessageBox.Yes:
                if selected_row:
                    ...
                    if delete_esquema_celda_central(self.Usuario,self._codCentral,self.inputCelda.text(),book_id):
    ...
    def refresh_table_from_child_window(self):
        ...
        data = select_esquema_celda_central(self._codCentral,self.inputCelda.text())
...
#
    ...
    def add_book(self):
        ...
        if self.check_inputs():
            ...
            #self.label_nota_obligatoria.hide()
            data = (self.Usuario,inputCodigo,inputCelda,inputSecuencia,inputX,inputY) 
            
            if insert_book_celda_central_generacion_ubicacion_esquema(data):
