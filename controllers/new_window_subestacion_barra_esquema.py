...
from views.new_transmision_barra_ubicacion_esquema import Ui_NewBook
from db.books import buscar_usuario_acceso,insert_book_barra_ubicacion_esquema
...
#
    ...
    def add_book(self):
        ...
        if self.check_inputs():
            ...
            if insert_book_barra_ubicacion_esquema(data):
                #self.clean_inputs()
