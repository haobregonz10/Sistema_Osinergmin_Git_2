...
from views.new_central_conductor_plano import Ui_NewBook
from db.books import buscar_usuario_acceso,insert_book_conductor_central_generacion_planta
...
class NewBookWindow(QDialog,Ui_NewBook):
    def __init__(self, parent=None,_codCelda=None,_codCentral=None,_codigo=None):
        ...
        self.inputConductor.setText(str(_codCelda))
        self.inputConductor.setEnabled(False)
        self.populate_combobox()


    def populate_combobox(self):

        # Llenar el combo de Código de Fase
        cb_options_fase = ("", "R", "S", "T")
        self.cbFase.addItems(cb_options_fase)
...
#
    ...
    def add_book(self):
        ...
        inputBarra = self.inputConductor.text()
        ...
        if self.check_inputs():
            ...
            #self.label_nota_obligatoria.hide()
            data = (self.Usuario,inputCodigo,inputBarra,cbFase,inputSecuencia,inputX,inputY,inputZ) 
            
            if insert_book_conductor_central_generacion_planta(data):
                #self.clean_inputs()
