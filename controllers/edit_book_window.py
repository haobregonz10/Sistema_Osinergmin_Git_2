...
from db.books import select_book_by_id,UpdateAutoriza,EncontrarAutorizaArea, update_book,select_all_personalFeban,select_all_areaTabla, select_all_EntidadTabla,select_all_motivoTabla,select_all_visitantesDNI, select_all_visitantesNombres,EncontrarDni,ExisteDni,ExisteAutoriza,ExisteEntidad,ExisteMotivo,ExisteVisita,insert_NuevoEntidad,insert_NuevoAutoriza,insert_NuevoDNI,insert_NuevoMotivo,insert_NuevoVisita,EncontrarNombreVisitante,ExisteNombreVisitante,UpdateVisitante,EncontrarAreasDelBn,EncontrarPisoSeleccionado,EncontrarAreaSeleccionada
