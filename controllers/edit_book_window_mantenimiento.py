...
class EditBookWindow(QWidget, EditBookFormMantenimiento):
    ...
    def VerificarNombreVisitante(self,NombreVisitante):
        ...
        print("POS DEL VIS1! : "+str(posicionVisitante))
    ...
    def AnadirNuevos(self, dni,visitante,entidadempresa,motivovisita,aquienvisita,autoriza,area,piso):
        if (ExisteDni_mantenimiento(dni)):
            print("DNI SI EXISTE!")
            update_NuevoDNI_mantenimientoV2(dni,visitante,entidadempresa,motivovisita,aquienvisita,autoriza,area,piso)
        else:
            print("DNI NO EXISTE!")
