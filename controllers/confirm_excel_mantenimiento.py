...
from views.confirm_excel_mantenimiento import ConfirmExcelMantenimiento
from PySide2 import QtCore
from pys2_msgboxes import msg_boxes
from db.books import generar_data_excel_fechas_locadores, generar_data_excel_fechas_mantenimiento, generar_data_excel_hoy, generar_data_excel_fechas, generar_data_excel_hoy_mantenimiento

from datetime import date
from PySide2.QtGui import *

class ConfirmExcel(QWidget,ConfirmExcelMantenimiento):
    ...
    def generarExcelHoy(self):
        ...
        generar_data_excel_hoy_mantenimiento(fechabusqueda)
    ...
    def generarExcelFechas(self):
        ...
        if HoraInicio=="" or HoraFin=="":
            ...
            generar_data_excel_fechas_mantenimiento(HoraInicio,HoraFin)
            msg_boxes.correct_msgbox("Generación de Excel","Se ha generado el archivo Excel exitosamente. Puede encontrarlo en la carpeta 'Reportes'")
            self.close()
