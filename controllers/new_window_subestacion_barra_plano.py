...
from views.new_transmision_barra_ubicacion_plano import Ui_NewBook
from db.books import insert_book_barra_plano_planta,buscar_usuario_acceso
...
#
    ...
    def add_book(self):
        ...
        if self.check_inputs():
            ...
            if insert_book_barra_plano_planta(data):
                #self.clean_inputs()
