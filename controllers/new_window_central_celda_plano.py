...
from views.new_central_celda_ubicacion_plano import Ui_NewBook
from db.books import delete_plano_celda_central,buscar_usuario_acceso,insert_book_celda_central_generacion_planta,select_plano_celda_central
...
class NewBookWindow(QDialog,Ui_NewBook):
    def __init__(self, parent=None,_codCelda=None,_codCentral=None,_codigo=None):
        ...
        self.table_config()
        self.populate_table(select_plano_celda_central(self._codCentral,self.inputCelda.text()))
        ...
        if len(selected_row)!=0:
            ...
            if respuesta== QMessageBox.Yes:
                if selected_row:
                    ...
                    if delete_plano_celda_central(self.Usuario,self._codCentral,self.inputCelda.text(),book_id):
    ...
    def refresh_table_from_child_window(self):
        ...
        data = select_plano_celda_central(self._codCentral,self.inputCelda.text())
...
#
    ...
    def add_book(self):
        ...
        if self.check_inputs():
            ...
            if insert_book_celda_central_generacion_planta(data):
