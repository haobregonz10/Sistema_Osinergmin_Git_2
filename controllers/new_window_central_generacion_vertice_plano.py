...
from views.new_central_generacion_vertice_plano import Ui_NewBook
from db.books import buscar_usuario_acceso,insert_book_central_generacion_vertice_plano,select_central_perimetro,delete_plano_central
...
#
        ...
        self.table_config()
        self.populate_table(select_central_perimetro(self._codCentral))
        ...
        if len(selected_row)!=0:
            ...
            if respuesta== QMessageBox.Yes:
                if selected_row:
                    ...
                    if delete_plano_central(self.Usuario,self._codCentral,book_id):
    ...
    def refresh_table_from_child_window(self):
        ...
        data = select_central_perimetro(self.inputCentral.text(),self.inputCodigo.text())
    ...
    def add_book(self):
        ...
        if self.check_inputs():
            ...
            if insert_book_central_generacion_vertice_plano(data):
                ...
                data = select_central_perimetro(self._codCentral)
