...
from views.confirm_excel import ConfirmExcel
from PySide2 import QtCore
from pys2_msgboxes import msg_boxes
from db.books import generar_data_excel_hoy, generar_data_excel_fechas

from datetime import date
from PySide2.QtGui import *

class ConfirmExcel(QWidget,ConfirmExcel):
    ...
    def generarExcelHoy(self):
        ...
        generar_data_excel_hoy(fechabusqueda)
    ...
    def generarExcelFechas(self):
        ...
        if HoraInicio=="" or HoraFin=="":
            ...
            generar_data_excel_fechas(HoraInicio,HoraFin)
            msg_boxes.correct_msgbox("Generación de Excel","Se ha generado el archivo Excel exitosamente. Puede encontrarlo en la carpeta 'Reportes'")
            self.close()
