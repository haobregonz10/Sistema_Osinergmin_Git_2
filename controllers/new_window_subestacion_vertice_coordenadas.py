...
from views.new_transmision_subestacion_coordenadas import Ui_NewBook
from db.books import delete_geografica_subestacion,buscar_usuario_acceso,insert_book_subestacion_coordenadas_geograficas,select_coordenadas_subestacion
...
#
        self.table_config()
        self.populate_table(select_coordenadas_subestacion(self._codCentral))
        #self.cancelButton.clicked.connect(self.close)
        ...
        if len(selected_row)!=0:
            ...
            if respuesta== QMessageBox.Yes:
                if selected_row:
                    ...
                    if delete_geografica_subestacion(self.Usuario,self._codCentral,book_id):
    ...
    def refresh_table_from_child_window(self):
        ...
        data = select_coordenadas_subestacion(self._codCentral)
    ...
    def add_book(self):
        ...
        if self.check_inputs():
            ...
            if insert_book_subestacion_coordenadas_geograficas(data):
