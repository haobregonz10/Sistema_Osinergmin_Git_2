...
from views.new_central_barra_ubicacion_plano import Ui_NewBook
from db.books import buscar_usuario_acceso,insert_book_barra_central_generacion_planta
...
#
    ...
    def add_book(self):
        ...
        if self.check_inputs():
            ...
            #self.label_nota_obligatoria.hide()
            data = (self.Usuario,inputCodigo,inputBarra,inputSegmento,cbFase,inputSecuencia,inputX,inputY,inputZ) 
            
            if insert_book_barra_central_generacion_planta(data):
                #self.clean_inputs()
