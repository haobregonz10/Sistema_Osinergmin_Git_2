...
from views.new_transmision_celda_ubicacion_esquema import Ui_NewBook
from db.books import delete_esquema_celda_subestacion,insert_book_celda_ubicacion_esquema,buscar_usuario_acceso,select_esquema_celda_subestacion
...
class NewBookWindow(QDialog,Ui_NewBook):
    def __init__(self, parent=None,_codCelda=None,_codCentral=None,_codigo=None):
        ...
        self.table_config()
        self.populate_table(select_esquema_celda_subestacion(self._codCentral,self.inputCelda.text()))
        ...
        if len(selected_row)!=0:
            ...
            if respuesta== QMessageBox.Yes:
                if selected_row:
                    ...
                    if delete_esquema_celda_subestacion(self.Usuario,self._codCentral,self.inputCelda.text(),book_id):
    ...
    def refresh_table_from_child_window(self):
        ...
        data = select_esquema_celda_subestacion(self._codCentral,self.inputCelda.text())
...
#
    ...
    def add_book(self):
        ...
        if self.check_inputs():
            ...
            if insert_book_celda_ubicacion_esquema(data):
