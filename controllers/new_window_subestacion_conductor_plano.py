...
from views.new_transmision_conductor_plano import Ui_NewBook
from db.books import insert_book_conductor_ubicacion_plano,buscar_usuario_acceso
...
#
    ...
    def add_book(self):
        ...
        if self.check_inputs():
            ...
            if insert_book_conductor_ubicacion_plano(data):
                #self.clean_inputs()
