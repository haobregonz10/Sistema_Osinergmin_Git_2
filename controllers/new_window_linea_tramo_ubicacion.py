...
from views.new_transmision_tramo_linea_ubicacion import Ui_NewBook
from db.books import buscar_usuario_acceso,insert_book_tramo_linea_transmision_ubicacion_geografica
...
#
    ...
    def add_book(self):
        ...
        if self.check_inputs():
            ...
            #self.label_nota_obligatoria.hide()
            data = (self.Usuario,inputCodigo,inputBarra,inputSecuencia,inputX,inputY,inputZ) 
            
            if insert_book_tramo_linea_transmision_ubicacion_geografica(data):
                #self.clean_inputs()
