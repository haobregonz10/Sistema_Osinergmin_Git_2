...
from views.new_transmision_bobina import Ui_NewBook
from db.books import buscar_usuario_acceso,insert_book_bobina,insert_book_bobina_ubicacion_esquema,insert_book_bobina_ubicacion_plano
    ...
    def add_book(self):
        ...
        if self.check_inputs():
            ...
            if insert_book_bobina(data):
                ...
                insert_book_bobina_ubicacion_esquema(data2)
                insert_book_bobina_ubicacion_plano(data3)
    ...
    def populate_inputs(self, book_id):
        ...
        if conn:
            try:
                ...
                # Consulta a la tabla Bobina_Bloqueo
                sql = "SELECT * FROM Bobina_Bloqueo WHERE COD_BOBINA = ?"
                ...
                if row:
                    ...
                    # Poblar los campos de entrada de la tabla Bobina_Bloqueo
                    ...
                    # Consulta a la tabla Bobina_Bloqueo_Ubicacion_Esquema
                    sql_esquema = "SELECT * FROM Bobina_Bloqueo_Ubicacion_Esquema WHERE COD_BOBINA = ?"
                    ...
                    if row_esquema:
                        ...
                        # Poblar los campos de entrada de la tabla Bobina_Bloqueo_Ubicacion_Esquema
                        self.inputX_2.setText(inputX_2)
                        self.inputY_2.setText(inputY_2)
                        self.inputANG_2.setText(inputANG_2)

                    # Consulta a la tabla Bobina_Bloqueo_Ubicacion_Plano_Planta
                    sql_plano = "SELECT * FROM Bobina_Bloqueo_Ubicacion_Plano_Planta WHERE COD_BOBINA = ?"
                    ...
                    if row_plano:
                        ...
                        # Poblar los campos de entrada de la tabla Bobina_Bloqueo_Ubicacion_Plano_Planta
