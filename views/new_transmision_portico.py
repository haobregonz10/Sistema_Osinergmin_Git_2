...
################################################################################
## Form generated from reading UI file 'new_transmision_portico.ui'
##
...
class Ui_NewBook(object):
    def setupUi(self, NewBook):
        ...
        NewBook.resize(712, 523)
        NewBook.setMinimumSize(QSize(693, 523))
        NewBook.setMaximumSize(QSize(712, 523))
...
"}")
        ...
        self.label.setGeometry(QRect(20, 10, 681, 41))
        font = QFont()
        ...
        self.inputCentral.setGeometry(QRect(120, 95, 121, 31))
        self.inputCentral.setFont(font1)
        self.addButton = QPushButton(NewBook)
        self.addButton.setObjectName(u"addButton")
        self.addButton.setGeometry(QRect(70, 470, 271, 41))
        font2 = QFont()
...
"}")
        ...
        self.cancelButton.setGeometry(QRect(360, 470, 271, 41))
...
"}")
        ...
        self.label_aquienVisita.setGeometry(QRect(120, 70, 151, 25))
        self.label_area = QLabel(NewBook)
        self.label_area.setObjectName(u"label_area")
        self.label_area.setGeometry(QRect(600, 70, 101, 25))
        ...
        self.label_nota_obligatoria.setGeometry(QRect(20, 440, 281, 21))
        ...
        self.label_advertencia_dni.setGeometry(QRect(20, 440, 251, 21))
        self.cbTipo = QComboBox(NewBook)
        self.cbTipo.setObjectName(u"cbTipo")
        self.cbTipo.setGeometry(QRect(380, 95, 211, 31))
        ...
        self.label_area_2.setGeometry(QRect(380, 70, 61, 25))
        ...
        self.btnDeleteEstructura.setGeometry(QRect(670, 250, 31, 31))
        font4 = QFont()
...
"}")
        ...
        self.btnAddEstructura.setGeometry(QRect(630, 250, 31, 31))
...
"}")
        ...
        self.inputAltura.setGeometry(QRect(600, 95, 101, 31))
        ...
        self.tableEstructura.setGeometry(QRect(20, 280, 681, 161))
        ...
        self.cbCalificacion.setGeometry(QRect(250, 95, 121, 31))
        ...
        self.label_area_3.setGeometry(QRect(250, 70, 111, 25))
        self.groupBox = QGroupBox(NewBook)
        self.groupBox.setObjectName(u"groupBox")
        self.groupBox.setGeometry(QRect(320, 130, 381, 101))
        font5 = QFont()
        ...
        self.inputEstructura.setMaxLength(14)
        ...
        self.inputEstructura2.setMaxLength(14)
    ...
    def retranslateUi(self, NewBook):
        ...
        self.label_4.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p><span style=\" font-size:9pt; font-weight:600;\">Estructura:</span></p></body></html>", None))
        ...
        self.label_area_3.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">Calificaci\u00f3n:</span></p></body></html>", None))
