...
################################################################################
## Form generated from reading UI file 'new_central_seccionador.ui'
##
...
class Ui_NewBook(object):
    def setupUi(self, NewBook):
        ...
        NewBook.resize(840, 374)
        NewBook.setMinimumSize(QSize(840, 374))
        NewBook.setMaximumSize(QSize(840, 374))
...
"}")
        ...
        self.label.setGeometry(QRect(20, 10, 811, 41))
        font = QFont()
        ...
        self.addButton.setGeometry(QRect(120, 320, 291, 41))
        font2 = QFont()
...
"}")
        ...
        self.cancelButton.setGeometry(QRect(460, 320, 271, 41))
...
"}")
        ...
        self.cbEstado.setGeometry(QRect(430, 155, 121, 31))
        ...
        self.inputFecha.setGeometry(QRect(560, 155, 131, 31))
        font3 = QFont()
        ...
        self.cbTipo.setGeometry(QRect(530, 95, 141, 31))
        ...
        self.inputMarca.setGeometry(QRect(190, 155, 111, 31))
        ...
        self.inputAnio.setGeometry(QRect(310, 155, 111, 31))
        ...
        self.label_autoriza_3.setGeometry(QRect(310, 130, 101, 25))
        self.cbTipoInstalacion = QComboBox(NewBook)
        self.cbTipoInstalacion.setObjectName(u"cbTipoInstalacion")
        self.cbTipoInstalacion.setGeometry(QRect(680, 95, 151, 31))
        ...
        self.groupBox_2.setGeometry(QRect(500, 200, 331, 101))
        font4 = QFont()
