...
################################################################################
## Form generated from reading UI file 'new_transmision_interruptor_esquema.ui'
##
...
"}")
        ...
        self.inputInterruptor = QLineEdit(NewBook)
        self.inputInterruptor.setObjectName(u"inputInterruptor")
        self.inputInterruptor.setGeometry(QRect(480, 90, 151, 31))
        self.inputInterruptor.setFont(font1)
    ...
    def retranslateUi(self, NewBook):
        ...
        self.label.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">INTERRUPTOR - UBICACI\u00d3N ESQUEMA</span></p></body></html>", None))
        ...
        self.label_motivoVisita_3.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Interruptor:</span></p></body></html>", None))
