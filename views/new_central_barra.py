...
################################################################################
## Form generated from reading UI file 'new_central_barra.ui'
##
...
class Ui_NewBook(object):
    def setupUi(self, NewBook):
        ...
        NewBook.resize(853, 579)
        NewBook.setMinimumSize(QSize(853, 464))
        NewBook.setMaximumSize(QSize(853, 579))
...
"}")
        ...
        self.addButton.setGeometry(QRect(120, 520, 291, 41))
        font2 = QFont()
...
"}")
        ...
        self.cancelButton.setGeometry(QRect(440, 520, 271, 41))
...
"}")
        ...
        self.inputFecha.setGeometry(QRect(390, 165, 131, 31))
        font3 = QFont()
        ...
        self.inputArreglo.setGeometry(QRect(370, 95, 291, 31))
        ...
        self.inputInstalacion.setGeometry(QRect(680, 95, 161, 31))
        ...
        self.inputTension.setGeometry(QRect(20, 165, 111, 31))
        ...
        self.label_horaIngreso_4.setGeometry(QRect(140, 140, 111, 25))
        self.cbBarra = QComboBox(NewBook)
        self.cbBarra.setObjectName(u"cbBarra")
        self.cbBarra.setGeometry(QRect(140, 165, 111, 31))
        ...
        self.label_nota_obligatoria_2.setGeometry(QRect(70, 70, 21, 21))
        self.btnDeletePlano = QPushButton(NewBook)
        self.btnDeletePlano.setObjectName(u"btnDeletePlano")
        self.btnDeletePlano.setGeometry(QRect(390, 220, 24, 30))
        font4 = QFont()
...
"}")
        ...
        self.label_4.setGeometry(QRect(20, 220, 311, 30))
        self.label_4.setScaledContents(True)
        self.btnAddPlano = QPushButton(NewBook)
        self.btnAddPlano.setObjectName(u"btnAddPlano")
        self.btnAddPlano.setGeometry(QRect(360, 220, 24, 30))
...
"}")
        ...
        self.tablePlano.setGeometry(QRect(20, 250, 401, 233))
        ...
        self.btnDeleteEsquema.setGeometry(QRect(800, 220, 24, 30))
...
"}")
        ...
        self.tableEsquema.setGeometry(QRect(440, 250, 391, 233))
        ...
        self.label_5.setGeometry(QRect(440, 220, 261, 30))
        self.label_5.setScaledContents(True)
        self.btnAddEsquema = QPushButton(NewBook)
        self.btnAddEsquema.setObjectName(u"btnAddEsquema")
        self.btnAddEsquema.setGeometry(QRect(770, 220, 24, 30))
...
"}")
        ...
        self.inputCodEmpresa.setGeometry(QRect(530, 165, 121, 31))
        ...
        self.label_empresa.setGeometry(QRect(530, 140, 111, 21))
    ...
    def retranslateUi(self, NewBook):
        ...
        self.label_area_2.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">Tipo Arreglo:</span></p></body></html>", None))
        ...
        self.label_nota_obligatoria_2.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p><span style=\" font-size:10pt; font-weight:600; font-style:italic; color:#ff0000;\">*</span></p></body></html>", None))
