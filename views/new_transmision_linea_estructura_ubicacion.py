...
################################################################################
## Form generated from reading UI file 'new_transmision_linea_estructura_ubicacion.ui'
##
...
"}")
        ...
        self.inputCompensador = QLineEdit(NewBook)
        self.inputCompensador.setObjectName(u"inputCompensador")
        self.inputCompensador.setGeometry(QRect(480, 90, 151, 31))
        self.inputCompensador.setFont(font1)
        ...
        self.inputCompensador_2 = QLineEdit(NewBook)
        self.inputCompensador_2.setObjectName(u"inputCompensador_2")
        self.inputCompensador_2.setGeometry(QRect(20, 150, 111, 31))
        self.inputCompensador_2.setFont(font1)
        self.label_motivoVisita_4 = QLabel(NewBook)
        self.label_motivoVisita_4.setObjectName(u"label_motivoVisita_4")
        self.label_motivoVisita_4.setGeometry(QRect(20, 130, 101, 21))
        self.inputANG_2 = QLineEdit(NewBook)
        self.inputANG_2.setObjectName(u"inputANG_2")
        self.inputANG_2.setGeometry(QRect(500, 150, 111, 31))
        ...
        self.label_motivoVisita_5.setGeometry(QRect(500, 130, 101, 21))
    ...
    def retranslateUi(self, NewBook):
        ...
        self.label.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">UBICACI\u00d3N GEOGR\u00c1FICA</span></p></body></html>", None))
        ...
        self.label_aquienVisita.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">L\u00ednea de Transmisi\u00f3n:</span></p></body></html>", None))
        ...
        self.label_motivoVisita_3.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Datum:</span></p></body></html>", None))
        self.label_motivoVisita_2.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Z:</span></p></body></html>", None))
        self.label_motivoVisita_4.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Zona:</span></p></body></html>", None))
        self.label_motivoVisita_5.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">ANG:</span></p></body></html>", None))
    # retranslateUi
