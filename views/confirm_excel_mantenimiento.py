...
################################################################################
## Form generated from reading UI file 'confirm_excel_mantenimiento.ui'
##
...
class ConfirmExcelMantenimiento(object):
...
"}")
        ...
        self.cancelButton.setGeometry(QRect(350, 350, 271, 41))
        font1 = QFont()
