...
################################################################################
## Form generated from reading UI file 'new_transmision_transformador_esquema.ui'
##
...
"}")
        ...
        self.i = QLabel(NewBook)
        self.i.setObjectName(u"i")
        self.i.setGeometry(QRect(140, 70, 191, 21))
        ...
        self.inputTransformador = QLineEdit(NewBook)
        self.inputTransformador.setObjectName(u"inputTransformador")
        self.inputTransformador.setGeometry(QRect(480, 90, 151, 31))
        self.inputTransformador.setFont(font1)
    ...
    def retranslateUi(self, NewBook):
        ...
        self.label.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">TRANSFORMADOR - UBICACI\u00d3N ESQUEMA</span></p></body></html>", None))
        ...
        self.i.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Subestaci\u00f3n:</span></p></body></html>", None))
        ...
        self.label_motivoVisita_3.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Transformador:</span></p></body></html>", None))
