...
################################################################################
## Form generated from reading UI file 'new_completo_book_window_personal.ui'
##
...
"}")
        ...
        self.editButton = QPushButton(NewBook)
...
"}")
        ...
        self.label_observaciones = QLabel(NewBook)
        ...
        self.ast_visitante.setGeometry(QRect(640, 70, 16, 21))
        ...
        self.label_advertencia_dni.setGeometry(QRect(20, 480, 231, 21))
    ...
    def retranslateUi(self, NewBook):
        NewBook.setWindowTitle(QCoreApplication.translate("NewBook", u"Modificar Registro", None))
        self.label.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">MODIFICAR REGISTRO</span></p></body></html>", None))
        ...
        self.editButton.setText(QCoreApplication.translate("NewBook", u"MODIFICAR", None))
        ...
        self.label_visitante.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">APELLIDOS Y NOMBRES DEL PERSONAL:</span></p></body></html>", None))
        self.label_observaciones.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">OBSERVACIONES:</span></p></body></html>", None))
