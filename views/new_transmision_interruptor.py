...
################################################################################
## Form generated from reading UI file 'new_transmision_interruptor.ui'
##
...
class Ui_NewBook(object):
    def setupUi(self, NewBook):
        ...
        NewBook.resize(861, 440)
        NewBook.setMinimumSize(QSize(861, 440))
        NewBook.setMaximumSize(QSize(861, 440))
...
"}")
        ...
        self.cbEstado.setGeometry(QRect(420, 165, 121, 31))
        ...
        self.inputFecha.setGeometry(QRect(550, 165, 131, 31))
        font3 = QFont()
        ...
        self.inputTension.setGeometry(QRect(20, 165, 151, 31))
        ...
        self.cbTipo.setGeometry(QRect(690, 95, 161, 31))
        ...
        self.label_area_3.setGeometry(QRect(690, 70, 141, 25))
        self.inputMarca = QLineEdit(NewBook)
        self.inputMarca.setObjectName(u"inputMarca")
        self.inputMarca.setGeometry(QRect(180, 165, 111, 31))
        ...
        self.label_autoriza_2.setGeometry(QRect(180, 140, 101, 25))
        self.inputAnio = QLineEdit(NewBook)
        self.inputAnio.setObjectName(u"inputAnio")
        self.inputAnio.setGeometry(QRect(300, 165, 111, 31))
        ...
        self.label_autoriza_3.setGeometry(QRect(300, 140, 101, 25))
        self.cbCalificacion = QComboBox(NewBook)
        self.cbCalificacion.setObjectName(u"cbCalificacion")
        self.cbCalificacion.setGeometry(QRect(530, 95, 151, 31))
        ...
        self.label_area_4.setGeometry(QRect(530, 70, 141, 25))
        self.groupBox = QGroupBox(NewBook)
        self.groupBox.setObjectName(u"groupBox")
        self.groupBox.setGeometry(QRect(20, 210, 391, 161))
        font4 = QFont()
        ...
        self.label_horaIngreso_4.setGeometry(QRect(10, 90, 71, 25))
        ...
        self.groupBox_2.setGeometry(QRect(460, 210, 391, 101))
