...
################################################################################
## Form generated from reading UI file 'new_central_barra_ubicacion_esquema.ui'
##
...
class Ui_NewBook(object):
    def setupUi(self, NewBook):
        ...
        NewBook.resize(652, 207)
        NewBook.setMinimumSize(QSize(652, 207))
        NewBook.setMaximumSize(QSize(652, 207))
...
"}")
        ...
        self.label.setMinimumSize(QSize(611, 41))
        self.label.setMaximumSize(QSize(611, 41))
        font = QFont()
        ...
        self.addButton.setGeometry(QRect(40, 140, 271, 41))
        font2 = QFont()
...
"}")
        ...
        self.inputBarra.setGeometry(QRect(160, 90, 151, 31))
        ...
        QWidget.setTabOrder(self.inputCodigo, self.addButton)
    ...
    def retranslateUi(self, NewBook):
        ...
        self.label.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">BARRA UBICACI\u00d3N ESQUEMA</span></p></body></html>", None))
