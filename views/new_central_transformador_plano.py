...
################################################################################
## Form generated from reading UI file 'new_central_transformador_plano.ui'
##
...
"}")
        ...
        self.inputCentral.setGeometry(QRect(140, 90, 331, 31))
...
"}")
    ...
    def retranslateUi(self, NewBook):
        ...
        self.label.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">TRANSFORMADOR - PLANO DE PLANTA</span></p></body></html>", None))
