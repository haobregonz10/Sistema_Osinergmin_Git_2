...
################################################################################
## Form generated from reading UI file 'new_transmision_bobina.ui'
##
...
class Ui_NewBook(object):
    def setupUi(self, NewBook):
        ...
        NewBook.resize(706, 429)
        NewBook.setMinimumSize(QSize(706, 429))
        NewBook.setMaximumSize(QSize(706, 429))
...
"}")
        ...
        self.addButton.setGeometry(QRect(50, 380, 291, 41))
        font2 = QFont()
...
"}")
        ...
        self.cancelButton.setGeometry(QRect(370, 380, 271, 41))
...
"}")
        ...
        self.inputTension.setGeometry(QRect(540, 95, 151, 31))
        ...
        self.groupBox_2.setGeometry(QRect(360, 200, 331, 101))
        ...
        self.label_empresa.setGeometry(QRect(530, 135, 111, 21))
    ...
    def retranslateUi(self, NewBook):
        ...
        self.label.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">BOBINA DE BLOQUEO</span></p></body></html>", None))
