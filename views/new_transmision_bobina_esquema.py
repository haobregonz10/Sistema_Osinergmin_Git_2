...
################################################################################
## Form generated from reading UI file 'new_transmision_bobina_esquema.ui'
##
...
"}")
    ...
    def retranslateUi(self, NewBook):
        ...
        self.label.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">PARARRAYO - UBICACI\u00d3N ESQUEMA</span></p></body></html>", None))
