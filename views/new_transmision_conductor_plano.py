...
################################################################################
## Form generated from reading UI file 'new_transmision_conductor_plano.ui'
##
...
"}")
        ...
        self.cbFase.setGeometry(QRect(340, 85, 101, 31))
        font2 = QFont()
        font2.setPointSize(12)
        self.cbFase.setFont(font2)
        ...
        self.label_horaSalida_2.setGeometry(QRect(120, 120, 81, 25))
        self.inputConductor = QLineEdit(NewBook)
        self.inputConductor.setObjectName(u"inputConductor")
        self.inputConductor.setGeometry(QRect(160, 85, 171, 31))
        self.inputConductor.setFont(font2)
        self.inputCodigo = QLineEdit(NewBook)
        self.inputCodigo.setObjectName(u"inputCodigo")
        self.inputCodigo.setGeometry(QRect(20, 85, 131, 31))
        ...
        self.label_horaIngreso_2.setGeometry(QRect(20, 120, 71, 25))
        self.label_motivoVisita_2 = QLabel(NewBook)
        self.label_motivoVisita_2.setObjectName(u"label_motivoVisita_2")
        self.label_motivoVisita_2.setGeometry(QRect(220, 120, 91, 25))
    ...
    def retranslateUi(self, NewBook):
        ...
        self.label.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">CONDUCTOR - PLANO DE PLANTA</span></p></body></html>", None))
        ...
        self.label_motivoVisita_4.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">Fase:</span></p></body></html>", None))
        self.label_horaIngreso_4.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">Secuencia:</span></p></body></html>", None))
