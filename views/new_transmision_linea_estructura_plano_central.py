...
################################################################################
## Form generated from reading UI file 'new_transmision_linea_estructura_plano_central.ui'
##
...
"}")
        ...
        self.label.setGeometry(QRect(10, 10, 631, 41))
        font = QFont()
...
"}")
        ...
        self.inputANG_2.setGeometry(QRect(380, 150, 111, 31))
        ...
        self.label_motivoVisita_5.setGeometry(QRect(380, 130, 101, 21))
    ...
    def retranslateUi(self, NewBook):
        ...
        self.label.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">UBICACI\u00d3N DENTRO DEL PLANO DE CENTRAL</span></p></body></html>", None))
        ...
        self.label_motivoVisita_3.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Central:</span></p></body></html>", None))
