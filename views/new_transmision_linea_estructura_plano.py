...
################################################################################
## Form generated from reading UI file 'new_transmision_linea_estructura_plano.ui'
##
...
"}")
    ...
    def retranslateUi(self, NewBook):
        ...
        self.label.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">UBICACI\u00d3N DENTRO DEL PLANO DE SUBESTACI\u00d3N</span></p></body></html>", None))
        ...
        self.label_motivoVisita_3.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Subestaci\u00f3n:</span></p></body></html>", None))
