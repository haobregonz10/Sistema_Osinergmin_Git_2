...
################################################################################
## Form generated from reading UI file 'new_central_transformador_medicion.ui'
##
...
class Ui_NewBook(object):
    def setupUi(self, NewBook):
        ...
        NewBook.resize(882, 393)
        NewBook.setMinimumSize(QSize(882, 393))
        NewBook.setMaximumSize(QSize(882, 393))
...
"}")
        ...
        self.label.setGeometry(QRect(20, 10, 851, 41))
        font = QFont()
        ...
        self.addButton.setGeometry(QRect(140, 340, 291, 41))
        font2 = QFont()
...
"}")
        ...
        self.cancelButton.setGeometry(QRect(460, 340, 271, 41))
...
"}")
        ...
        self.cbTipo.setGeometry(QRect(370, 95, 161, 31))
        ...
        self.label_area_3.setGeometry(QRect(370, 70, 141, 25))
        ...
        self.label_autoriza_4.setGeometry(QRect(710, 70, 151, 25))
        self.inputTension = QLineEdit(NewBook)
        self.inputTension.setObjectName(u"inputTension")
        self.inputTension.setGeometry(QRect(710, 95, 161, 31))
        ...
        self.cbTipoInstalacion.setGeometry(QRect(540, 95, 161, 31))
        ...
        self.label_area_4.setGeometry(QRect(540, 70, 141, 25))
        ...
        self.inputCodEmpresa.setGeometry(QRect(530, 155, 121, 31))
        ...
        self.label_empresa.setGeometry(QRect(530, 130, 111, 21))
    ...
    def retranslateUi(self, NewBook):
        ...
        self.label.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">TRANSFORMADOR DE MEDICI\u00d3N</span></p></body></html>", None))
        ...
        self.label_area_4.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">Tipo Instalaci\u00f3n:</span></p></body></html>", None))
