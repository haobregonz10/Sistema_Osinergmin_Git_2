...
################################################################################
## Form generated from reading UI file 'new_transmision_tramo_linea_ubicacion.ui'
##
...
"}")
        ...
        self.label_area_2.setGeometry(QRect(120, 70, 121, 21))
        self.label_horaSalida_3 = QLabel(NewBook)
        self.label_horaSalida_3.setObjectName(u"label_horaSalida_3")
        self.label_horaSalida_3.setGeometry(QRect(450, 70, 81, 25))
        ...
        self.label_motivoVisita_3.setGeometry(QRect(250, 70, 101, 25))
        ...
        self.inputBarra.setGeometry(QRect(120, 95, 121, 31))
        ...
        self.label_horaIngreso_3.setGeometry(QRect(350, 70, 71, 25))
        ...
        self.label_horaSalida_4 = QLabel(NewBook)
        self.label_horaSalida_4.setObjectName(u"label_horaSalida_4")
        self.label_horaSalida_4.setGeometry(QRect(550, 70, 81, 25))
    ...
    def retranslateUi(self, NewBook):
        ...
        self.label.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">TRAMO L\u00cdNEA - UBICACI\u00d3N GEOGR\u00c1FICA</span></p></body></html>", None))
        ...
        self.label_area_2.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">Tramo:</span></p></body></html>", None))
        ...
        self.label_horaSalida_4.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">Z:</span></p></body></html>", None))
    # retranslateUi
