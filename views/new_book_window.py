...
"}")
        ...
        self.ast_dni.setGeometry(QRect(200, 140, 21, 21))
        ...
        self.ast_visitante.setGeometry(QRect(640, 140, 21, 21))
        ...
        QWidget.setTabOrder(self.areaVisitadaLineEdit, self.dateEditNuevo)
