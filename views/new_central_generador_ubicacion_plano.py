...
################################################################################
## Form generated from reading UI file 'new_central_generador_ubicacion_plano.ui'
##
...
"}")
        ...
        self.inputZ.setGeometry(QRect(300, 160, 111, 31))
        ...
        self.label_motivoVisita_2.setGeometry(QRect(440, 140, 131, 21))
        self.inputANG = QLineEdit(NewBook)
        self.inputANG.setObjectName(u"inputANG")
        self.inputANG.setGeometry(QRect(440, 160, 111, 31))
