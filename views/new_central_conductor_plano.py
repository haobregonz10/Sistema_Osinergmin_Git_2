...
################################################################################
## Form generated from reading UI file 'new_central_conductor_plano.ui'
##
...
"}")
        ...
        self.addButton.setGeometry(QRect(40, 210, 291, 41))
        font1 = QFont()
...
"}")
        ...
        self.cancelButton.setGeometry(QRect(340, 210, 271, 41))
...
"}")
        ...
        self.inputConductor.setGeometry(QRect(160, 90, 171, 31))
        font2 = QFont()
        ...
        self.inputSecuencia.setGeometry(QRect(460, 90, 171, 31))
        ...
        self.label_motivoVisita_4.setGeometry(QRect(340, 65, 101, 25))
        self.cbFase = QComboBox(NewBook)
        self.cbFase.setObjectName(u"cbFase")
        self.cbFase.setGeometry(QRect(340, 90, 101, 31))
        ...
        self.label_motivoVisita_2.setGeometry(QRect(220, 125, 91, 25))
        self.inputY = QLineEdit(NewBook)
        self.inputY.setObjectName(u"inputY")
        self.inputY.setGeometry(QRect(120, 150, 91, 31))
