...
################################################################################
## Form generated from reading UI file 'new_transmision_bobina_plano.ui'
##
...
"}")
        ...
        self.inputBobina = QLineEdit(NewBook)
        self.inputBobina.setObjectName(u"inputBobina")
        self.inputBobina.setGeometry(QRect(480, 90, 151, 31))
        self.inputBobina.setFont(font1)
    ...
    def retranslateUi(self, NewBook):
        ...
        self.label.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">BOBINA DE BLOQUEO  - PLANO DE PLANTA</span></p></body></html>", None))
        ...
        self.label_motivoVisita_3.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Bobina:</span></p></body></html>", None))
