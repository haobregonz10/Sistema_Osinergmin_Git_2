...
################################################################################
## Form generated from reading UI file 'new_transmision_seccionador.ui'
##
...
"}")
        ...
        self.label.setGeometry(QRect(20, 10, 841, 41))
        font = QFont()
        ...
        self.inputSubestacion.setGeometry(QRect(140, 95, 221, 31))
        self.inputSubestacion.setFont(font1)
        self.addButton = QPushButton(NewBook)
        self.addButton.setObjectName(u"addButton")
        self.addButton.setGeometry(QRect(120, 390, 291, 41))
        font2 = QFont()
...
"}")
        ...
        self.cancelButton.setGeometry(QRect(460, 390, 271, 41))
...
"}")
        ...
        self.cbEstado.setGeometry(QRect(600, 155, 121, 31))
        ...
        self.inputFecha.setGeometry(QRect(730, 155, 131, 31))
        font3 = QFont()
        ...
        self.inputMarca.setGeometry(QRect(360, 155, 111, 31))
        ...
        self.label_autoriza_2.setGeometry(QRect(360, 130, 101, 25))
        self.inputAnio = QLineEdit(NewBook)
        self.inputAnio.setObjectName(u"inputAnio")
        self.inputAnio.setGeometry(QRect(480, 155, 111, 31))
        ...
        self.label_autoriza_3.setGeometry(QRect(480, 130, 101, 25))
        self.cbTipoInstalacion = QComboBox(NewBook)
        self.cbTipoInstalacion.setObjectName(u"cbTipoInstalacion")
        self.cbTipoInstalacion.setGeometry(QRect(20, 155, 161, 31))
        ...
        self.label_autoriza_4.setGeometry(QRect(190, 130, 151, 25))
        self.inputTension = QLineEdit(NewBook)
        self.inputTension.setObjectName(u"inputTension")
        self.inputTension.setGeometry(QRect(190, 155, 161, 31))
        ...
        self.cbCalificacion.setGeometry(QRect(700, 95, 161, 31))
        ...
        self.label_area_4.setGeometry(QRect(700, 70, 141, 25))
        self.groupBox = QGroupBox(NewBook)
        self.groupBox.setObjectName(u"groupBox")
        self.groupBox.setGeometry(QRect(20, 200, 391, 161))
        font4 = QFont()
        ...
        self.label_motivoVisita_2.setGeometry(QRect(250, 30, 131, 25))
        ...
        self.label_horaIngreso_4.setGeometry(QRect(10, 90, 74, 25))
        sizePolicy1 = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Preferred)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.label_horaIngreso_4.sizePolicy().hasHeightForWidth())
        self.label_horaIngreso_4.setSizePolicy(sizePolicy1)
        self.inputANG = QLineEdit(self.groupBox)
        self.inputANG.setObjectName(u"inputANG")
        self.inputANG.setGeometry(QRect(10, 115, 111, 31))
        self.inputANG.setFont(font1)
        self.inputANG.setMaxLength(11)
        self.groupBox_2 = QGroupBox(NewBook)
        self.groupBox_2.setObjectName(u"groupBox_2")
        self.groupBox_2.setGeometry(QRect(460, 200, 391, 101))
        ...
        self.label_motivoVisita_3.setGeometry(QRect(250, 30, 121, 25))
    ...
    def retranslateUi(self, NewBook):
        ...
        self.label.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">SECCIONADOR</span></p></body></html>", None))
