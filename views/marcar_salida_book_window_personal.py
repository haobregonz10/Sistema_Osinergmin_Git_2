...
################################################################################
## Form generated from reading UI file 'marcar_salida_book_window_personal.ui'
##
...
"}")
    ...
    def retranslateUi(self, MarcarSalida):
        ...
        self.label_visitante.setText(QCoreApplication.translate("MarcarSalida", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">APELLIDOS Y NOMBRES DEL PERSONAL:</span></p></body></html>", None))
