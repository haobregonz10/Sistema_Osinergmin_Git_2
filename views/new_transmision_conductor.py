...
################################################################################
## Form generated from reading UI file 'new_transmision_conductor.ui'
##
...
class Ui_NewBook(object):
    def setupUi(self, NewBook):
        ...
        NewBook.resize(721, 544)
        NewBook.setMinimumSize(QSize(721, 434))
        NewBook.setMaximumSize(QSize(721, 1000))
...
"}")
        ...
        self.label.setGeometry(QRect(20, 10, 691, 41))
        font = QFont()
        ...
        self.addButton.setGeometry(QRect(70, 490, 271, 41))
        font2 = QFont()
...
"}")
        ...
        self.cancelButton.setGeometry(QRect(380, 490, 271, 41))
...
"}")
        ...
        self.label_motivoVisita.setGeometry(QRect(160, 130, 131, 25))
        self.label_nota_obligatoria = QLabel(NewBook)
        self.label_nota_obligatoria.setObjectName(u"label_nota_obligatoria")
        self.label_nota_obligatoria.setGeometry(QRect(20, 470, 281, 21))
        ...
        self.label_advertencia_dni.setGeometry(QRect(20, 470, 251, 21))
        ...
        self.inputFecha.setGeometry(QRect(160, 155, 131, 31))
        font3 = QFont()
...
"}")
        ...
        self.tableEsquema.setGeometry(QRect(370, 230, 325, 233))
        ...
        self.btnDeletePlano.setGeometry(QRect(320, 200, 24, 30))
...
"}")
        ...
        self.tablePlano.setGeometry(QRect(20, 230, 325, 233))
        ...
        self.btnAddPlano.setGeometry(QRect(290, 200, 24, 30))
...
"}")
        ...
        self.label_empresa.setGeometry(QRect(300, 135, 111, 21))
        ...
        self.inputCodEmpresa.setGeometry(QRect(300, 155, 121, 31))
    ...
    def retranslateUi(self, NewBook):
        ...
        self.label.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">CONDUCTOR</span></p></body></html>", None))
        ...
        self.label_autoriza_2.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">Calificaci\u00f3n:</span></p></body></html>", None))
