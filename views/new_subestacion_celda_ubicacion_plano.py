...
"}")
        ...
        self.addButton.setGeometry(QRect(30, 200, 291, 41))
        font2 = QFont()
...
"}")
        ...
        self.label_horaSalida.setGeometry(QRect(160, 130, 81, 16))
        self.label_motivoVisita = QLabel(NewBook)
        self.label_motivoVisita.setObjectName(u"label_motivoVisita")
        self.label_motivoVisita.setGeometry(QRect(300, 130, 131, 21))
