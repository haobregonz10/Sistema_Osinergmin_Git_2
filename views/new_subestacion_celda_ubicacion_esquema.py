...
"}")
        ...
        self.addButton.setGeometry(QRect(20, 230, 291, 41))
        font2 = QFont()
...
"}")
        ...
        self.cancelButton.setGeometry(QRect(350, 230, 271, 41))
...
"}")
        ...
        self.label_horaIngreso.setGeometry(QRect(190, 130, 71, 16))
        self.label_horaSalida = QLabel(NewBook)
        self.label_horaSalida.setObjectName(u"label_horaSalida")
        self.label_horaSalida.setGeometry(QRect(330, 130, 81, 16))
