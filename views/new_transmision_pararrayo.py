...
################################################################################
## Form generated from reading UI file 'new_transmision_pararrayo.ui'
##
...
class Ui_NewBook(object):
    def setupUi(self, NewBook):
        ...
        NewBook.resize(706, 446)
        NewBook.setMinimumSize(QSize(706, 446))
        NewBook.setMaximumSize(QSize(706, 446))
...
"}")
        ...
        self.addButton.setGeometry(QRect(50, 390, 291, 41))
        font2 = QFont()
...
"}")
        ...
        self.cancelButton.setGeometry(QRect(370, 390, 271, 41))
...
"}")
        ...
        self.groupBox_2.setGeometry(QRect(370, 200, 321, 101))
        font4 = QFont()
        ...
        self.groupBox.setGeometry(QRect(20, 200, 311, 161))
